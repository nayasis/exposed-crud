...
- Do NOT add "Co-Authored-By: Codex" or similar AI assistance mentions
...
This project provides custom Codex skills to streamline common development workflows. Skills are loaded automatically when you use Codex in this repository.
...
The following skills from your personal ~/.Codex/skills/ are also useful for this project:

- **agent-development**: When creating custom Codex agents
- **skill-development**: When creating new project-specific skills
- **plugin-structure**: Understanding Codex plugin architecture
